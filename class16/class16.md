...
Now we get to run DESeq on our
data.
...
This is a summary volcano plot of our results to
date.
...
`BiocManager::install("org.Hs.eg.db")` in the console.
...
First, we need to install the packages in the R console using
`BiocManager::install( c("pathview", "gage", "gageData"))`.

We have to load them up to use
    them.
...
We are going to look at the first 3 pathways of the data to see if these
pathways overlap with our differences:
...
Make an input vector of our numeric quantity of interest i.e. flod
chande vauses and make sure it has ENTREZ gene names associated with it.
We are going to take the entrez column and add it to the foldcahnges
column.
...
What is in our results? We can use the `attributes()` fucntion to see
...
```
    ...
    ## Info: Working in directory /Users/CINDYTRAN/Desktop/BIMM 143/bimm143_github/class16
